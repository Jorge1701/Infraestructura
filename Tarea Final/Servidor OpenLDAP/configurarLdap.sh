...
echo "" >> $path"slapd.conf"
echo "index   cn              press,sub,eq" >> $path"slapd.conf"
echo "index   sn              press,sub,eq" >> $path"slapd.conf"
echo "index   uid             press,sub,eq" >> $path"slapd.conf"
echo "index   displayName     press,sub,eq" >> $path"slapd.conf"
