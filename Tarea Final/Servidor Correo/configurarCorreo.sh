...
echo "service imap-login {" >> "$master"
echo "  inet_listener imap {" >> "$master"
echo "  }" >> "$master"
echo "  inet_listener imaps {" >> "$master"
echo "  }" >> "$master"
echo "}" >> "$master"
echo "service pop3-login {" >> "$master"
echo "  inet_listener pop3 {" >> "$master"
echo "  }" >> "$master"
echo "  inet_listener pop3s {" >> "$master"
echo "  }" >> "$master"
echo "}" >> "$master"
echo "service lmtp {" >> "$master"
echo "  unix_listener lmtp {" >> "$master"
echo "  }" >> "$master"
echo "}" >> "$master"
echo "service imap {" >> "$master"
echo "}" >> "$master"
echo "service pop3 {" >> "$master"
echo "}" >> "$master"
echo "service auth {" >> "$master"
echo "  unix_listener auth-userdb {" >> "$master"
echo "    mode = 0640" >> "$master"
...
echo "  }" >> "$master"
echo "}" >> "$master"
echo "service auth-worker {" >> "$master"
echo "}" >> "$master"
echo "service dict {" >> "$master"
echo "  unix_listener dict {" >> "$master"
echo "  }" >> "$master"
echo "}" >> "$master"
